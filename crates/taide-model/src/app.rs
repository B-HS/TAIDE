...
impl PromptTemplateId {
    pub fn as_str(self) -> &'static str {
        match self {
            PromptTemplateId::AutoTabDefault => AUTO_TAB_PROMPT_ID,
            PromptTemplateId::InlineEditDefault => INLINE_EDIT_PROMPT_ID,
            PromptTemplateId::CommitMessageDefault => COMMIT_MESSAGE_PROMPT_ID,
        }
    }
}
