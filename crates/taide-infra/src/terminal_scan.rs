...
//!
//! Replaces the per-sequence `extract_*` scans that used to live in [`crate::shell_integration`]
...
use crate::shell_integration::CommandMarker;
...
/// bare path TAIDE's own shell hooks emit (see [`crate::shell_integration`]). A payload
