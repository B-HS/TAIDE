...
use taide_model::locale::{LocalePack, LocaleSummary, ResolvedLocale, LOCALE_SCHEMA_VERSION};
...
const MESSAGE_NAMESPACES: &[(&str, &[&str])] = &[
    ...
    (
        ...
        &[
            ...
            "closeToRight",
            "closeSaved",
            "confirmCloseDirtyTitle",
            "confirmCloseDirtyDescription",
            "confirmCloseDirtyDescriptionMany",
            "confirmCloseDirtySave",
            "confirmCloseDirtyDiscard",
            "pin",
            "unpin",
            "split",
            "copyRelativePath",
    ...
    (
        ...
        &[
            ...
            "editorBracketPairGuidesDescription",
            "editorRulers",
            "editorRulersHint",
            "editorRulersPlaceholder",
            "editorSmoothScrolling",
            "editorSmoothScrollingDescription",
            "editorCursorSmoothCaretAnimation",
            "editorCursorSmoothCaretAnimationDescription",
            "editorSuggestPreview",
            "editorSuggestPreviewDescription",
            "editorDiffHideUnchangedRegions",
            "editorDiffHideUnchangedRegionsDescription",
            "editorDiffShowMoves",
            "editorDiffShowMovesDescription",
            "organizeImportsOnSave",
            "organizeImportsOnSaveDescription",
            "fixAllOnSave",
            "fixAllOnSaveDescription",
            "trimTrailingWhitespaceOnSave",
            "trimTrailingWhitespaceOnSaveDescription",
            "insertFinalNewlineOnSave",
            "insertFinalNewlineOnSaveDescription",
            "editorConfigEnabled",
            "editorConfigEnabledDescription",
            "editorCodeLens",
            "editorCodeLensDescription",
            "terminalScrollback",
            "terminalScrollbackHint",
            "terminalCursorStyle",
            "terminalCursorBlink",
            "enablePreviewTabs",
            "enablePreviewTabsHint",
            "explorerAutoReveal",
            "explorerAutoRevealDescription",
            "cursorStyleLine",
            "cursorStyleBlock",
            ...
            "welcomeOnEmptyEditorDescription",
            "notifications",
            "notificationsEnabled",
            "notificationsEnabledDescription",
            "notificationsOnlyWhenUnfocused",
            "notificationsOnlyWhenUnfocusedDescription",
            "notificationsAgentCompleted",
            "notificationsAgentAwaitingInput",
            "notificationsAgentAwaitingInputDescription",
            "notificationsTaskCompleted",
            "notificationsGitRemote",
            "notificationsSearchReplace",
            "notificationsLspInstall",
            "notificationsError",
    ...
    (
        ...
        &[
            ...
            "ai.timeout",
            "ai.unauthorized",
            "app.promptTemplateInvalidJson",
            "archive.entryReadFailed",
            "archive.extractSizeLimitExceeded",
            "archive.gzExtractFailed",
            "archive.openFailed",
            "archive.tarGzExtractFailed",
            "archive.tarXzExtractFailed",
            "archive.tooManyEntries",
            "archive.unzipFailed",
            "archive.zipOpenFailed",
            "file.copyIntoSelf",
            "file.destinationExists",
            "file.mtimeConvertFailed",
            "file.mtimeReadFailed",
            "file.notAFile",
            "file.notFound",
            ...
            "git.blobTooLarge",
            "git.branchNotMerged",
            "git.branchTargetUnresolvable",
            "git.cannotDeleteCheckedOutBranch",
            "git.checkoutConflict",
            "git.commandFailed",
            "git.commandTimedOut",
            "git.conflict",
            "git.conflictInfoNotFound",
            "git.headUnresolvable",
            "git.hunkNotFound",
            "git.hunkRangeOutOfFile",
            "git.indexNotClean",
            "git.locked",
            "git.network",
            "git.noChanges",
            "git.noNewlineAtEofLineStageUnsupported",
            "git.objectNotFound",
            "git.operationFailed",
            "git.pathOutsideRepository",
            "git.rangeHasNoChangedLines",
            "git.rangeHunkNotFound",
            "git.rangeSpansMultipleHunks",
            "git.remoteBranchNotFound",
            "git.remoteRefMalformed",
            "git.repositoryNotFound",
            "git.repositoryOpenFailed",
            "git.spawnFailed",
            "git.stashApplyConflict",
            "git.unbornBranch",
            ...
            "lsp.downloadInfoMissing",
            "lsp.downloadRequestFailed",
            "lsp.downloadStreamFailed",
            "lsp.extractTaskFailed",
            "lsp.installAlreadyRunning",
            "lsp.installCancelled",
            "lsp.platformUnsupported",
            "lsp.sdkDetectOnly",
            "lsp.serverSpawnFailed",
            "lsp.stdinUnavailable",
            "lsp.stdoutUnavailable",
            "lsp.toolchainInfoMissing",
            "lsp.toolchainNotFound",
            "lsp.toolchainRunFailed",
            "lsp.unresolvedArgTemplate",
            "notification.settingsUnsupported",
            "path.invalid",
            "path.invalidIdentifier",
            "path.outsideOpenProjects",
            "path.outsideProjectRoot",
            "plugin.alreadyInstalled",
            "plugin.manifestNotFound",
            "plugin.manifestParseFailed",
            "plugin.manifestVersionUnsupported",
            "plugin.pathOutsideRoot",
            "plugin.reloadAfterInstallFailed",
            "project.displayInvalid",
            "project.pathNotDirectory",
            "project.pathNotFound",
            "projectGroup.invalid",
            "projectGroup.memberUnknown",
            ...
            "remote.deniedSelfAccessExpansion",
            "remote.deniedSharedSingletonStateRace",
            "remote.deniedUnclassified",
            "remote.deniedUnreachableDesktopWindow",
            "remote.disconnected",
            "remote.passwordTooShort",
            "remote.serverNotRunning",
            "search.invalidRegex",
            "secret.accessFailed",
            "secret.deleteFailed",
            "secret.readFailed",
            ...
            "vsix.entryNotFound",
            "vsix.entryNotUtf8",
            "vsix.entryPathEscape",
            "vsix.entryReadFailed",
            "vsix.entryTooLarge",
            "vsix.nameMissing",
            "vsix.noImportableLanguages",
            "vsix.noLanguageContributions",
            "vsix.openFailed",
            "vsix.packageJsonParseFailed",
            "vsix.publisherMissing",
...
mod tests {
    ...
    fn 내장_카탈로그_원문에_중복_키가_없다() {
        ...
        for (locale_id, source, parsed_len) in [
            (BUILTIN_EN_ID, include_str!("../resources/locales/en.json"), en_messages().len()),
            (BUILTIN_KO_ID, include_str!("../resources/locales/ko.json"), ko_messages().len()),
            (BUILTIN_JA_ID, include_str!("../resources/locales/ja.json"), ja_messages().len()),
        ] {
