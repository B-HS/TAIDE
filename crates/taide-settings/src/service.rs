...
use taide_model::remote::ALLOWED_HOST_WILDCARD_PREFIX;
...
/// the Tauri sync service's `parse_synced_payload` can apply the same normalization to a
...
mod tests {
    use super::*;
    use taide_model::settings::{DEFAULT_GIT_GRAPH_PANEL_SIZE_PX, DEFAULT_SEARCH_ON_TYPE_DEBOUNCE_MS};
