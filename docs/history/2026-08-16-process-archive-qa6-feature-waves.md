# PROCESS 아카이브 — QA6 후속·기능 확장 1~3차 (2026-08-12~14)

> 2026-08-16 아카이브. `docs/PROCESS.md` 에서 이관된 완료 섹션이다(잔여 기능 캠페인 A~I 착수 전
> 사용자 요구·실기 보고 작업). 미완료로 남은 '실기 확인 대기' 항목은 전문 QA·
> `docs/quality-assurance/2026-08-11-qa6-checklist.md` 로 이월됐다. 직전 전체 아카이브는
> `docs/history/2026-08-14-process-archive-docs-to-w7.md`.
