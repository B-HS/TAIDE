...
## 진행 중: 사용자 기능 버그 14건 수정·병합·릴리스 초안 (2026-09-22)
...
- [ ] d. 전체 검증·문서화·선별 커밋·dev 푸시 — verify 통과(Bun 2,949개·Rust 1,775개), 프로덕션 빌드·E2E 타입 검사 통과. 수정 보고서와 v0.2.6 노트 작성, 선별 커밋 완료 후 일반 푸시합니다.
- [ ] e. main 병합·릴리스 초안 — 원격 최신 상태·버전 정본을 확인하고 버전/노트를 반영한 뒤 일반 병합·태그 푸시, CI·릴리스 자산·draft 상태까지 확인합니다.
