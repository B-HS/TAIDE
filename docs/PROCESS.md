...
> 현재 세부 실행 항목은 M3입니다. M2는 완료됐고, M3의 공통 infra·self-write·root guard·persist·watcher·range·URL·archive·LSP 설치 경계를 검증했습니다. Git/LSP 프로세스/PTY 및 나머지 infra 자원 이전과 M4~M8은 아직 미완료입니다.
