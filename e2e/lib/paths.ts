 ...
 * still outside the Vite root; `Library/Caches/dev.taide.app/` co-locates the throwaway trees
 * with the app's own cache namespace (this harness is already macOS-only — see
 * {@link REMOTE_LOG_PATH}).
 */
export const E2E_FIXTURE_PROJECTS_DIR = path.join(os.homedir(), 'Library/Caches/dev.taide.app/e2e-fixtures')
